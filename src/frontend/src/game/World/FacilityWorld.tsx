...
export function FacilityWorld() {
  ...
  useFrame((state, delta) => {
    ...
    if (flickerLightRef.current) {
      ...
      flickerLightRef.current.intensity = 1.5 * flicker;
    }
  });
  ...
  return (
    <>
      ...
      <ambientLight intensity={0.5} color="#3a3a3a" />
      <hemisphereLight 
        color="#4a4a5a" 
        groundColor="#1a1a1a" 
        intensity={0.6} 
      ...
      <group position={[0, 0, -5]}>
        ...
        <mesh receiveShadow position={[0, 0, 0]} rotation={[-Math.PI / 2, 0, 0]}>
          ...
          <meshStandardMaterial color="#353535" roughness={0.9} metalness={0.1} />
        </mesh>
        ...
        <mesh position={[1, 0.6, -8]} castShadow userData={{ type: 'keycard', id: 'keycard1' }}>
          ...
          <meshStandardMaterial color="#e4b584" emissive="#e4b584" emissiveIntensity={0.5} />
        </mesh>
        ...
        <mesh position={[0, 1.2, -18]} castShadow userData={{ type: 'terminal', id: 'terminal1' }}>
          ...
          <meshStandardMaterial color="#3a3a3a" emissive="#5a5a3a" emissiveIntensity={0.2} />
        </mesh>
      </group>
